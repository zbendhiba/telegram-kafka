...
- Camel AtlasMap ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/atlasmap.html)): Transforms the message using an AtlasMap transformation
